...
class SpecialMap(MapFactory):
    ...
    class Objects:
        ...
        def get_objects(self, _map):
            ...
            for obj_name in self.enemies:
                prop = object_list_prob['enemies'][obj_name]
                for i in range(self.enemies[obj_name]):
                    coord = (random.randint(1, 30), random.randint(1, 22))
                    intersect = True
                    while intersect:
                        intersect = False
